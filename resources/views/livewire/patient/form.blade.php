        ...
        <div class="card-body py-4">
            ...
            @csrf
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-8">
                        <select wire:model="health_status_id" id="health_status_id" class="form-control form-control-sm">
                        ...
                        @if($health_status_id != null)
                        <div class="alert alert-light my-3" role="alert">
                            <strong class="d-block"><i class="bi bi-info-circle-fill"></i> {{ $health_status_name }}</strong>
