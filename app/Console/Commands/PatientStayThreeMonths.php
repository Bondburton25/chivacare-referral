                    ...
                    "contents": {
                        ...
                        "body": {
                            ...
                            "contents": [
                                ...
                                {
                                    "type": "text",
                                    "text": "'.__('Chivacare') .' '.__('congratulations') .' '.__('Because you receive referral fees') .' '.__('it is an amount of') .' '.__('1,500 Bath') .' '.__('from the patient you referred named') .' '.$patient->full_name .' '.__('which has been in service for') .' '.__('3') .' '.__('months') .' '.__('From the first day of stay') .' '.date('Y-m-d', strtotime($patient->arrive_date_time)).'",
                                    "size": "sm",
                                    "color": "#aaaaaa",
                                    "wrap": true,
                                    "margin": "md"
